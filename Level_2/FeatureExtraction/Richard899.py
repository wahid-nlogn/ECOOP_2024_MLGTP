...
class Task(TaskState):
    def __init__(self, i, p, w, initialState, r):
        ...
        taskWorkArea.taskTab.insert(i,self)
    ...
    def findtcb(self, id):
        t = taskWorkArea.taskTab[id] if id<len(taskWorkArea.taskTab) else taskWorkArea.taskTab[len(taskWorkArea.taskTab)-1]
        if t is None:
...
class HandlerTask(Task):
    def __init__(self, i:int, p:int, w:Packet, s, r:HandlerTaskRec):
        Task.__init__(self, i, p, w, s, r)
...
class IdleTask(Task):
    def __init__(self, i:int, p:int, w:int, s, r:IdleTaskRec):
...
A = ord('A')
class WorkTask(Task):
    def __init__(self, i:int, p:int, w:Packet, s, r:WorkerTaskRec):
        Task.__init__(self, i, p, w, s, r)
