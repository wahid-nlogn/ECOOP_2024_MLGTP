...
STATIC_ERRORS = True
CALL_GRAPH_GENERATION = False
BIT_STRING_GENERATION = False
...
def set(args):
    ...
    global CALL_GRAPH_GENERATION
    global NUMBER_LOOP_ITERATIONS
    global BIT_STRING_GENERATION
    ...
    CALL_GRAPH_GENERATION = args.call_graph_generation
    NUMBER_LOOP_ITERATIONS = args.number_loop_iterations
    BIT_STRING_GENERATION = args.bit_string_generation
