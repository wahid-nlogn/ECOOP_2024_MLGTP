...
print("---------------------------------------------------------------------------")
print("---------------------------------------------------------------------------")
print("Table-4 CAST-COST Performance")
print("---------------------------------------------------------------------------")
print("---------------------------------------------------------------------------")
print("---------------------------------------------------------------------------")
print("---------------------------------------------------------------------------")
print("---------------------------------------------------------------------------")
BENCHMARKS={"Pascal":loader.pascal_matrix_argcast(),"Nbody":loader.nbody(),"Sieve":loader.sieve(),"Meteor":loader.meteor(),"Scimark":loader.scimarkParCast(),"Raytrace":loader.raytraceParCast(),
            "Chaos":loader.chaosbenchmark()}
for benchmark in BENCHMARKS:
    ...
    for train_size in [40]:
        for model in MODEL:
            ...
            print('(Error ratio): {:4%}'.format(np.array(Loss_MAE).mean() / np.array(y_AVG).mean()))
